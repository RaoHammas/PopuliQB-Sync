...
public class PopPerson
{
    ...
    [JsonPropertyName("hispanic_latino")]
    public bool? HispanicLatino { get; set; }

    
    [JsonPropertyName("resident_alien")]
    ...
    [JsonPropertyName("deceased_date")]
...
public class PopStudent
{
    ...
    [JsonPropertyName("entrance_term_id")]
    ...
    [JsonPropertyName("exit_date")]
    public DateTime? ExitDate { get; set; }

    
    [JsonPropertyName("exit_reason_id")]
    public int? ExitReasonId { get; set; }

    
    [JsonPropertyName("loa_start_date")]
    public DateTime? LoaStartDate { get; set; }

    
    [JsonPropertyName("loa_end_date")]
    public DateTime? LoaEndDate { get; set; }

    
    [JsonPropertyName("proctored")]
    ...
    [JsonPropertyName("max_audit_hours")]
    public object? MaxAuditHours { get; set; }
...
public class PopEmailAddress
{
    ...
    public object? DeliveryProblem { get; set; }
